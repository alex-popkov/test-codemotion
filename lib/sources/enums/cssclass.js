goog.provide( 'test.codemotion.enums.CssClass' );

/**
 * Default CSS class to be applied to the root element of view.
 * @type {string}
 */
test.codemotion.enums.CssClass = {
    ...
    SELECT_CUSTOMER: goog.getCssName( 'select-customer' ),
    SELECT_PRODUCTS: goog.getCssName( 'select-products' )
};